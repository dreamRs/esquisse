...
test_that("get_code_scale works", {
  ...
  pal_fill_discrete <- get_code_scale(fill = "color", filltype = "categorical", params = list(palette = "Dark2"))
  ...
  pal_fill_ggplot2 <- get_code_scale(fill = "color", filltype = "categorical", params = list(palette = "ggplot2"))
  expect_null(pal_fill_ggplot2)
  
  pal_color_discrete <- get_code_scale(color = "color", colortype = "categorical", params = list(palette = "Dark2"))
  ...
  pal_color_ggplot2 <- get_code_scale(color = "color", colortype = "categorical", params = list(palette = "ggplot2"))
